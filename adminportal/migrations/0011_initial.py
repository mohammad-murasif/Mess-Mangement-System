...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('adminportal', '0010_remove_messfee_std_id_delete_messmenu_delete_messfee_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='MessFee',
            fields=[
                ('trans_id', models.IntegerField(primary_key=True, serialize=False, verbose_name='Transaction ID')),
                ...
                ('std_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='adminportal.student', verbose_name='Phone No.')),
            ],
        ),
    ]
