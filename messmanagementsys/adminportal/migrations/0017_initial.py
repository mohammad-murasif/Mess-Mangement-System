...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('adminportal', '0016_remove_messfee_std_id_delete_messmenu_delete_updates_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Student',
            fields=[
                ('std_id', models.AutoField(primary_key=True, serialize=False, verbose_name='Student ID:')),
